...
import com.jboyCorp.webserviceRestFul.domain.BankPayment;
import com.jboyCorp.webserviceRestFul.domain.CardPayment;
...
import com.jboyCorp.webserviceRestFul.domain.Payment;
...
import com.jboyCorp.webserviceRestFul.repositories.OrderRepository;
import com.jboyCorp.webserviceRestFul.repositories.PaymentRepository;
...
public class WebserviceRestFulApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null, "Mpow HC6 USB Headset with Microphone, Comfort-fit Office Computer Headphone",
				36.90);
		Product p3 = new Product(null,
				"Samsung Galaxy Buds+ Plus, True Wireless Earbuds (Wireless Charging Case included)", 149.99);
		Product p4 = new Product(null,
				"Car Vacuum, HOTOR Corded Car Vacuum Cleaner High Power for Quick Car Cleaning, DC 12V ", 25.49);
		...
		Client cli1 = new Client(null, "Maria Helena P.Lopes", "mariahelen@gmail.com", "07210559488",
				TypeClient.PESSOAFISICA);
		Client cli2 = new Client(null, "Joao Alfredo P.Lopes", "joaoalfredo_lopes@yahoo.com.br", "08769488835",
				TypeClient.PESSOAFISICA);
		Client cli3 = new Client(null, "Simoes & Barreira SC Ltda", "simoesbarra@gmail.com", "05755751000131",
				TypeClient.PESSOAJURIDICA);
		...
		Address addrs2 = new Address(null, "Rua Governador Pedro de Toledo", "56", "Apto 95", "Boqueirao", "11045-550",
				cli2, cit1);
		Address addrs3 = new Address(null, "Rua Anadir Dias de Carvalho", "586", "-", "Joquei Clube", "11450-515", cli2,
				cit7);
		Address addrs4 = new Address(null, "Avenida Dona Ana Costa", "413", "Conj.45", "Gonzaga", "11230-101", cli3,
				cit1);
		...
		Order ord1 = new Order(null, Instant.parse("2020-04-02T13:20:00Z"), cli1, addrs1);
		Order ord2 = new Order(null, Instant.parse("2020-04-05T15:25:34Z"), cli2, addrs3);
		Order ord3 = new Order(null, Instant.parse("2020-05-08T09:28:45Z"), cli2, addrs2);
		Order ord4 = new Order(null, Instant.parse("2020-05-28T21:32:58Z"), cli3, addrs4);
		
		Payment pay1 = new BankPayment(null, PaymentStatus.PAID_OUT, ord1, Instant.parse("2020-04-06T18:40:00Z"), Instant.parse("2020-04-06T21:00:00Z"));
		ord1.setPayment(pay1);
		Payment pay2 = new CardPayment(null, PaymentStatus.PAID_OUT, ord2, 4);
		ord2.setPayment(pay2);
		Payment pay3 = new CardPayment(null, PaymentStatus.PAID_OUT, ord3, 3);
		ord3.setPayment(pay3);
		Payment pay4 = new BankPayment(null, PaymentStatus.PENDING, ord4, Instant.parse("2020-05-28T00:05:00Z"), null);
		ord4.setPayment(pay4);
		
		cli1.getOrders().add(ord1);
		cli2.getOrders().addAll(Arrays.asList(ord2, ord3));
		cli3.getOrders().add(ord4);
